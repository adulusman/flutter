          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                Center(child: SvgPicture.asset("assets/Login.svg",height: height*0.34,width:width*1,)),
                SizedBox(height: height*0.05,),
                Center(
                  child: Text("Enter Your New Password",style: GoogleFonts.inter(
                      fontWeight: FontWeight.w700,fontSize:width*0.04,color: Color(0xFF141414)),),
                ),
